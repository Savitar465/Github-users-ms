package com.inspire.msusuarios.config.security;

import com.inspire.mscommon.exceptionhandler.exceptions.AuthTokenConvertException;
...
public class JwtAuthConverter implements Converter<Jwt, AbstractAuthenticationToken> {
    ...
    public AbstractAuthenticationToken convert(Jwt jwt) {
        try {
            ...
            log.error("Error al convertir el token {}", e);
